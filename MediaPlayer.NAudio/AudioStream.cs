...
namespace MediaPlayer.NAudio
{
    ...
    internal class AudioStream : WaveStream, ISampleProvider
    {
        ...
        private WaveChannel32 _readerStream; // the waveStream which we will use for all positioning
        ...
        public AudioStream(Uri source)
        {
            ...
            _readerStream = new WaveChannel32(CreateReaderStream(source));
        ...
        private static WaveStream CreateReaderStream(string fileName)
        {
            ...
            {
                case ".wav":
                    return CreatePcmStream(fileName);
                case ".mp3":
