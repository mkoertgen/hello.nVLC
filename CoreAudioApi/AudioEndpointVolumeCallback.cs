/*
  ...
  3. This notice may not be removed or altered from any source distribution.
   ...
   extracted from NAudio by Marcel Körtgen
 */
...
namespace CoreAudioApi
{
    ...
    internal class AudioEndpointVolumeCallback : IAudioEndpointVolumeCallback
    {
        ...
        public void OnNotify(IntPtr notifyData)
        {
            ...
            var offset = Marshal.OffsetOf(typeof (AudioVolumeNotificationDataStruct), nameof(AudioVolumeNotificationDataStruct.ChannelVolume));
