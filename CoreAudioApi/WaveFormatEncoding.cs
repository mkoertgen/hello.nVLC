namespace CoreAudioApi
{
    ...
    public enum WaveFormatEncoding : ushort
    {
        ...
        /// <summary></summary>
        WaveFormatNmsVbxadpcm = 0x0038, // Natural MicroSystems 

        /// <summary></summary>
        WaveFormatCsImaadpcm = 0x0039, // Crystal Semiconductor IMA ADPCM 

        /// <summary></summary>
        WaveFormatEchosc3 = 0x003A, // Echo Speech Corporation 

        /// <summary></summary>
        WaveFormatRockwellAdpcm = 0x003B, // Rockwell International 

        /// <summary></summary>
        WaveFormatRockwellDigitalk = 0x003C, // Rockwell International 

        /// <summary></summary>
        WaveFormatXebec = 0x003D, // Xebec Multimedia Solutions Limited 

        /// <summary></summary>
        WaveFormatG721Adpcm = 0x0040, // Antex Electronics Corporation 

        /// <summary></summary>
        WaveFormatG728Celp = 0x0041, // Antex Electronics Corporation 

        /// <summary></summary>
        WaveFormatMsg723 = 0x0042, // Microsoft Corporation 

        /// <summary>WAVE_FORMAT_MPEG, Microsoft Corporation </summary>
        Mpeg = 0x0050,

        /// <summary></summary>
        WaveFormatRt24 = 0x0052, // InSoft, Inc. 

        /// <summary></summary>
        WaveFormatPac = 0x0053, // InSoft, Inc. 

        /// <summary>WAVE_FORMAT_MPEGLAYER3, ISO/MPEG Layer3 Format Tag </summary>
        MpegLayer3 = 0x0055,

        /// <summary></summary>
        WaveFormatLucentG723 = 0x0059, // Lucent Technologies 

        /// <summary></summary>
        WaveFormatCirrus = 0x0060, // Cirrus Logic 

        /// <summary></summary>
        WaveFormatEspcm = 0x0061, // ESS Technology 

        /// <summary></summary>
        WaveFormatVoxware = 0x0062, // Voxware Inc 

        /// <summary></summary>
        WaveFormatCanopusAtrac = 0x0063, // Canopus, co., Ltd. 

        /// <summary></summary>
        WaveFormatG726Adpcm = 0x0064, // APICOM 

        /// <summary></summary>
        WaveFormatG722Adpcm = 0x0065, // APICOM 

        /// <summary></summary>
        WaveFormatDsatDisplay = 0x0067, // Microsoft Corporation 

        /// <summary></summary>
        WaveFormatVoxwareByteAligned = 0x0069, // Voxware Inc 

        /// <summary></summary>
        WaveFormatVoxwareAc8 = 0x0070, // Voxware Inc 

        /// <summary></summary>
        WaveFormatVoxwareAc10 = 0x0071, // Voxware Inc 

        /// <summary></summary>
        WaveFormatVoxwareAc16 = 0x0072, // Voxware Inc 

        /// <summary></summary>
        WaveFormatVoxwareAc20 = 0x0073, // Voxware Inc 

        /// <summary></summary>
        WaveFormatVoxwareRt24 = 0x0074, // Voxware Inc 

        /// <summary></summary>
        WaveFormatVoxwareRt29 = 0x0075, // Voxware Inc 

        /// <summary></summary>
        WaveFormatVoxwareRt29Hw = 0x0076, // Voxware Inc 

        /// <summary></summary>
        WaveFormatVoxwareVr12 = 0x0077, // Voxware Inc 

        /// <summary></summary>
        WaveFormatVoxwareVr18 = 0x0078, // Voxware Inc 

        /// <summary></summary>
        WaveFormatVoxwareTq40 = 0x0079, // Voxware Inc 

        /// <summary></summary>
        WaveFormatSoftsound = 0x0080, // Softsound, Ltd. 

        /// <summary></summary>
        WaveFormatVoxwareTq60 = 0x0081, // Voxware Inc 

        /// <summary></summary>
        WaveFormatMsrt24 = 0x0082, // Microsoft Corporation 

        /// <summary></summary>
        WaveFormatG729A = 0x0083, // AT&T Labs, Inc. 

        /// <summary></summary>
        WaveFormatMviMvi2 = 0x0084, // Motion Pixels 

        /// <summary></summary>
        WaveFormatDfG726 = 0x0085, // DataFusion Systems (Pty) (Ltd) 

        /// <summary></summary>
        WaveFormatDfGsm610 = 0x0086, // DataFusion Systems (Pty) (Ltd) 

        /// <summary></summary>
        WaveFormatIsiaudio = 0x0088, // Iterated Systems, Inc. 

        /// <summary></summary>
        WaveFormatOnlive = 0x0089, // OnLive! Technologies, Inc. 

        /// <summary></summary>
        WaveFormatSbc24 = 0x0091, // Siemens Business Communications Sys 

        /// <summary></summary>
        WaveFormatDolbyAc3Spdif = 0x0092, // Sonic Foundry 

        /// <summary></summary>
        WaveFormatMediasonicG723 = 0x0093, // MediaSonic 

        /// <summary></summary>
        WaveFormatProsody8Kbps = 0x0094, // Aculab plc 

        /// <summary></summary>
        WaveFormatZyxelAdpcm = 0x0097, // ZyXEL Communications, Inc. 

        /// <summary></summary>
        WaveFormatPhilipsLpcbb = 0x0098, // Philips Speech Processing 

        /// <summary></summary>
        WaveFormatPacked = 0x0099, // Studer Professional Audio AG 

        /// <summary></summary>
        WaveFormatMaldenPhonytalk = 0x00A0, // Malden Electronics Ltd. 
        ...
        /// <summary></summary>
        WaveFormatRhetorexAdpcm = 0x0100, // Rhetorex Inc. 

        /// <summary></summary>
        WaveFormatIrat = 0x0101, // BeCubed Software Inc. 

        /// <summary></summary>
        WaveFormatVivoG723 = 0x0111, // Vivo Software 

        /// <summary></summary>
        WaveFormatVivoSiren = 0x0112, // Vivo Software 

        /// <summary></summary>
        WaveFormatDigitalG723 = 0x0123, // Digital Equipment Corporation 

        /// <summary></summary>
        WaveFormatSanyoLdAdpcm = 0x0125, // Sanyo Electric Co., Ltd. 

        /// <summary></summary>
        WaveFormatSiprolabAceplnet = 0x0130, // Sipro Lab Telecom Inc. 

        /// <summary></summary>
        WaveFormatSiprolabAcelp4800 = 0x0131, // Sipro Lab Telecom Inc. 

        /// <summary></summary>
        WaveFormatSiprolabAcelp8V3 = 0x0132, // Sipro Lab Telecom Inc. 

        /// <summary></summary>
        WaveFormatSiprolabG729 = 0x0133, // Sipro Lab Telecom Inc. 

        /// <summary></summary>
        WaveFormatSiprolabG729A = 0x0134, // Sipro Lab Telecom Inc. 

        /// <summary></summary>
        WaveFormatSiprolabKelvin = 0x0135, // Sipro Lab Telecom Inc. 

        /// <summary></summary>
        WAVE_FORMAT_G726ADPCM = 0x0140, // Dictaphone Corporation 

        /// <summary></summary>
        WaveFormatQualcommPurevoice = 0x0150, // Qualcomm, Inc. 

        /// <summary></summary>
        WaveFormatQualcommHalfrate = 0x0151, // Qualcomm, Inc. 

        /// <summary></summary>
        WaveFormatTubgsm = 0x0155, // Ring Zero Systems, Inc. 

        /// <summary></summary>
        WaveFormatMsaudio1 = 0x0160, // Microsoft Corporation
        ...
        /// <summary></summary>
        WaveFormatUnisysNapAdpcm = 0x0170, // Unisys Corp. 

        /// <summary></summary>
        WaveFormatUnisysNapUlaw = 0x0171, // Unisys Corp. 

        /// <summary></summary>
        WaveFormatUnisysNapAlaw = 0x0172, // Unisys Corp. 

        /// <summary></summary>
        WaveFormatUnisysNap16K = 0x0173, // Unisys Corp. 

        /// <summary></summary>
        WaveFormatCreativeAdpcm = 0x0200, // Creative Labs, Inc 

        /// <summary></summary>
        WaveFormatCreativeFastspeech8 = 0x0202, // Creative Labs, Inc 

        /// <summary></summary>
        WaveFormatCreativeFastspeech10 = 0x0203, // Creative Labs, Inc 

        /// <summary></summary>
        WaveFormatUherAdpcm = 0x0210, // UHER informatic GmbH 

        /// <summary></summary>
        WaveFormatQuarterdeck = 0x0220, // Quarterdeck Corporation 

        /// <summary></summary>
        WaveFormatIlinkVc = 0x0230, // I-link Worldwide 

        /// <summary></summary>
        WaveFormatRawSport = 0x0240, // Aureal Semiconductor 

        /// <summary></summary>
        WaveFormatEsstAc3 = 0x0241, // ESS Technology, Inc. 

        /// <summary></summary>
        WaveFormatIpiHsx = 0x0250, // Interactive Products, Inc. 

        /// <summary></summary>
        WaveFormatIpiRpelp = 0x0251, // Interactive Products, Inc. 

        /// <summary></summary>
        WaveFormatCs2 = 0x0260, // Consistent Software 

        /// <summary></summary>
        WaveFormatSonyScx = 0x0270, // Sony Corp. 

        /// <summary></summary>
        WaveFormatFmTownsSnd = 0x0300, // Fujitsu Corp. 

        /// <summary></summary>
        WaveFormatBtvDigital = 0x0400, // Brooktree Corporation 

        /// <summary></summary>
        WaveFormatQdesignMusic = 0x0450, // QDesign Corporation 

        /// <summary></summary>
        WaveFormatVmeVmpcm = 0x0680, // AT&T Labs, Inc. 

        /// <summary></summary>
        WaveFormatTpc = 0x0681, // AT&T Labs, Inc. 

        /// <summary></summary>
        WaveFormatOligsm = 0x1000, // Ing C. Olivetti & C., S.p.A. 

        /// <summary></summary>
        WaveFormatOliadpcm = 0x1001, // Ing C. Olivetti & C., S.p.A. 

        /// <summary></summary>
        WaveFormatOlicelp = 0x1002, // Ing C. Olivetti & C., S.p.A. 

        /// <summary></summary>
        WaveFormatOlisbc = 0x1003, // Ing C. Olivetti & C., S.p.A. 

        /// <summary></summary>
        WaveFormatOliopr = 0x1004, // Ing C. Olivetti & C., S.p.A. 

        /// <summary></summary>
        WaveFormatLhCodec = 0x1100, // Lernout & Hauspie 

        /// <summary></summary>
        WaveFormatNorris = 0x1400, // Norris Communications, Inc. 

        /// <summary></summary>
        WaveFormatSoundspaceMusicompress = 0x1500, // AT&T Labs, Inc. 
        ...
        WaveFormatDvm = 0x2000, // FAST Multimedia AG 
