...
namespace CoreAudioApi
{
    ...
    {
        private readonly IAudioSessionEventsHandler _audioSessionEventsHandler;
        ...
        {
            _audioSessionEventsHandler = handler;
        }
        ...
        {
            _audioSessionEventsHandler.OnDisplayNameChanged(displayName);
        ...
        public int OnIconPathChanged(
            ...
            [In] ref Guid eventContext)
        {
            _audioSessionEventsHandler.OnIconPathChanged(iconPath);
        ...
        public int OnSimpleVolumeChanged(
            ...
            [In] ref Guid eventContext)
        {
            _audioSessionEventsHandler.OnVolumeChanged(volume, isMuted);
        ...
        public int OnChannelVolumeChanged(
            ...
            [In] ref Guid eventContext)
        {
            _audioSessionEventsHandler.OnChannelVolumeChanged(channelCount, newVolumes, channelIndex);
        ...
        public int OnGroupingParamChanged(
            ...
            [In] ref Guid eventContext)
        {
            _audioSessionEventsHandler.OnGroupingParamChanged(ref groupingId);
        ...
        {
            _audioSessionEventsHandler.OnStateChanged(state);
        ...
        {
            _audioSessionEventsHandler.OnSessionDisconnected(disconnectReason);
